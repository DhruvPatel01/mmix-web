...
var MMIXAL = (() => {
  ...
  return function(moduleArg = {}) {
    ...
    ["_malloc", "_memory", "___indirect_function_table", "_main", "onRuntimeInitialized"].forEach((prop) => {
...
var stdout_area = document.getElementById("xterm-container");
...
document.getElementById("compile-btn").addEventListener("click", (e) => {
  compile().then((mmo_content) => {
    ...
    mmix_default(MMIX_Module).then((mmix) => {
